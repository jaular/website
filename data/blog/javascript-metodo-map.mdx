...
summary: "EL método map puede tener muchos usos cuando se trabaja con matrices."
image: "/static/images/javascript-metodo-map/img.png"
---

<Image
  alt={`Método map()`}
  title={`Método map()`}
  src={`/static/images/javascript-metodo-map/img.png`}
  width={1200}
  height={630}
/>
